...
(function () {
  ...
  var TABLICA = {
    ...
    // Поворот оси НЕ ограничивается — решение Сергея (02.09, кольцо):
    // ось крутится на полный круг, сектор тут был бы зажимом ради зажима.
    // «Угол» остаётся для амплитуд и наклонов, у которых сектор осмыслен.
    'поворот':  { organ: 'ugol', ot0: 0, do: 360, minShag: 1, edinica: '°' },
  ...
  function izObyavleniya(zakon, mestaObj) {
    ...
    var gdeSekcii = null, priSekcii = null;
